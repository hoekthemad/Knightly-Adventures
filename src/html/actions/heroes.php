                    ...
                    <li class="list-group-item">
                        <div class="text-center">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#">Lineup Slot 1</a></li>
                                <li><a class="dropdown-item" href="#">Lineup Slot 2</a></li>
                                <li><a class="dropdown-item" onclick="setHeroLineup(<?= $heroInfo1['HeroNumber'] ?>, 3)">Lineup Slot 3</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
